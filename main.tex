...
\end{figure}
\section{Usage}
The tikz code of the figure is in the file block.tex and/or preamble.tex. If you want to use specific colour, see dp.tex for how to specify the colours in rgb. I have lifted and modified the basic structure of the figures in tikzpeople. So, latex credit goes to Neil.
